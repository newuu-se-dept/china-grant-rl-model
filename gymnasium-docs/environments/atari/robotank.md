...
<html>
  ...
  <body>
    <p>If you are not redirected automatically, follow this <a href="https://ale.farama.org/environments/robotank">link to Robotank's new page</a>.</p>
    <div id="popup" class="popup">
    <div class="popup-content">
        <p>Robotank's documentation has moved to <b>ale.farama.org</b></p>
        <label>
