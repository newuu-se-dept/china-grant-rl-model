...
<html>
  ...
  <body>
    <p>If you are not redirected automatically, follow this <a href="https://ale.farama.org/environments/kung_fu_master">link to Kung Fu Master's new page</a>.</p>
    <div id="popup" class="popup">
    <div class="popup-content">
        <p>Kung Fu Master's documentation has moved to <b>ale.farama.org</b></p>
        <label>
