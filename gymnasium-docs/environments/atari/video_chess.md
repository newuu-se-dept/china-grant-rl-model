...
<html>
  ...
  <body>
    <p>If you are not redirected automatically, follow this <a href="https://ale.farama.org/environments/video_chess">link to Video Chess's new page</a>.</p>
    <div id="popup" class="popup">
    <div class="popup-content">
        <p>Video Chess's documentation has moved to <b>ale.farama.org</b></p>
        <label>
