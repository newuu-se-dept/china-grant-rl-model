...
<html>
  <head>
    <title>Redirecting to Yars Revenge's documentation</title>
    <style>
  ...
  <body>
    <p>If you are not redirected automatically, follow this <a href="https://ale.farama.org/environments/yars_revenge">link to Yars Revenge's new page</a>.</p>
    <div id="popup" class="popup">
    <div class="popup-content">
        <p>Yars Revenge's documentation has moved to <b>ale.farama.org</b></p>
        <label>
