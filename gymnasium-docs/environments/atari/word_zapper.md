...
<html>
  <head>
    <title>Redirecting to Word Zapper's documentation</title>
    <style>
  ...
  <body>
    <p>If you are not redirected automatically, follow this <a href="https://ale.farama.org/environments/word_zapper">link to Word Zapper's new page</a>.</p>
    <div id="popup" class="popup">
    <div class="popup-content">
        <p>Word Zapper's documentation has moved to <b>ale.farama.org</b></p>
        <label>
  ...
  <script>
    ...
    window.onload = function() {
        ...
        if (atariAutoRedirect) {
            window.location.href = "https://ale.farama.org/environments/word_zapper";
        } else {
