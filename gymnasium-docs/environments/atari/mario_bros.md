...
<html>
  ...
  <body>
    <p>If you are not redirected automatically, follow this <a href="https://ale.farama.org/environments/mario_bros">link to Mario Bros's new page</a>.</p>
    <div id="popup" class="popup">
    <div class="popup-content">
        <p>Mario Bros's documentation has moved to <b>ale.farama.org</b></p>
        <label>
