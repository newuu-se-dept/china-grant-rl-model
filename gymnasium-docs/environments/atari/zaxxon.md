...
<html>
  <head>
    <title>Redirecting to Zaxxon's documentation</title>
    <style>
  ...
  <body>
    <p>If you are not redirected automatically, follow this <a href="https://ale.farama.org/environments/zaxxon">link to Zaxxon's new page</a>.</p>
    <div id="popup" class="popup">
    <div class="popup-content">
        <p>Zaxxon's documentation has moved to <b>ale.farama.org</b></p>
        <label>
