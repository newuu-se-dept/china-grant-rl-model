...
<html>
  ...
  <body>
    <p>If you are not redirected automatically, follow this <a href="https://ale.farama.org/environments/lost_luggage">link to Lost Luggage's new page</a>.</p>
    <div id="popup" class="popup">
    <div class="popup-content">
        <p>Lost Luggage's documentation has moved to <b>ale.farama.org</b></p>
        <label>
